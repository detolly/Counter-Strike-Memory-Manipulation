...
using laExternalMulti.Objects.IO;
using Vector3 = newHack.Aimbot.Vector3;
using System;
...
namespace laExternalMulti.Objects.Implementation.CSGO.Data.BSP
{
    //THIS CLASS OR ANYTHING OF THIS SYSTEM WAS NOT MADE BY ME.
    //FULL CREDIT GOES TO THE CUNT (nice cunt) THAT MADE IT ON GITHUB. 
    //IT'S LIKE THE ONLY C# MEGACHEAT ON THERE, SO YOU'LL FIND IT.
    public class BSP
    {
        #region VARIABLES
